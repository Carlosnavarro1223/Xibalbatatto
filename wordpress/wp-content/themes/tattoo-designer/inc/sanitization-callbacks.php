 ...
 */
function tattoo_designer_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function tattoodesigner_sanitize_css( $css ) {
 ...
 */
function tattoodesigner_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function tattoodesigner_sanitize_email( $email, $setting ) {
 ...
 */
function tattoodesigner_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function tattoodesigner_sanitize_html( $html ) {
 ...
 */
function tattoodesigner_sanitize_image( $image, $setting ) {
 ...
 */
function tattoodesigner_sanitize_nohtml( $nohtml ) {
 ...
 */
function tattoodesigner_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function tattoodesigner_sanitize_number_range( $number, $setting ) {
 ...
 */
function tattoodesigner_sanitize_select( $input, $setting ) {
 ...
 */
function tattoodesigner_sanitize_url( $url ) {
	return esc_url_raw( $url );
}

/*radio button sanitization*/
function tattoo_designer_sanitize_choices( $input, $setting ) {
    global $wp_customize;
...
if ( ! function_exists( 'tattoo_designer_sanitize_integer' ) ) {
	function tattoo_designer_sanitize_integer( $input ) {
		return (int) $input;
	}
}